...
- Except for SwiftUI's required `body`, do not keep local view fragments in variables or computed properties. Extract meaningful fragments into focused `View` types and favor new files under the feature's `Views/Components` folder.
